...
function pullupRefresh() {
    ...
    mui.post(url, {
        id: idd,
        vvip: tiaojian, // 1 微信  2全部
        store_code: code,
        staff_code:vip_staff_code,
        page: ++count,
        limit: limit_num
    }, function (data) {
        // console.log(count);
        ...
        if (data.code == 200) {
            ...
            setTimeout(function () {
                ...
                for (i = 0; i < data.data.data.length; i++) {
                    ...
                    if(data.data.data[i].birthday_g == null || data.data.data[i].birthday_g == undefined || data.data.data[i].birthday_g == ""){
                    ...
                    if(data.data.data[i].phone_g == null || data.data.data[i].phone_g == undefined || data.data.data[i].phone_g == ""){
